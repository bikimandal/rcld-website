...
export default function Tape2() {
  return (
    <div className="absolute m-0 p-0 w-full overflow-hidden bg-gradient-to-r from-red-200 to-blue-200 rotate-3 z-1">
      {/* First copy of the messages */}
      <div className="animate-scroll-reverse flex whitespace-nowrap py-3">
